...
$lang['help_childrenof'] = 'Cette option fera que le menu n\'affichera que les éléments descendants (enfants) de l\'ID ou de l\'alias de la page indiqué. Exemple : <code>{menu childrenof=$page_alias}</code> affichera uniquement les enfants de la page courante.';
...
$lang['help_items'] = 'Spécifie une liste des alias de pages (séparés par des virgules) que ce menu doit afficher.';
$lang['help_loadprops'] = 'Vous pouvez utiliser ce paramètre lorsque vous n\'utilisez PAS les propriétés avancées dans votre gabarit de gestionnaire de menu. Ce paramètre permet de désactiver le chargement des propriétés des contenus pour chaque nœuds (ex.: extra1, image, thumbnail, etc). Cette opération réduira considérablement le nombre de requêtes nécessaires à la construction d\'un menu tout en demandant une augmentation de la configuration de la mémoire minimale, mais enlève des possibiltés pour la construction de menus plus complexes.';
$lang['help_nlevels'] = 'Alias de number_of_levels (nombre de niveaux)';
$lang['help_number_of_levels'] = 'Ce réglage limite la profondeur du menu généré au nombre spécifié de niveaux. Par défaut la valeur de ce paramètre est illimité pour montrer tous les niveaux enfants sauf si vous utilisez le paramètre "items", dans ce cas number_of_levels sera égal à 1';
