...
<h3>À propos des styles et des couleurs :</h3>
  <p>Ce module fournit la possibilité <em>(facultative)</em> d\'associer une feuille de style avec le profil de l\'éditeur. Ainsi le contenu de l\'éditeur suivra les règles de mise en forme de la feuille de style.</p>
...
$lang['mthelp_profileallowtables'] = 'Laisser l\'éditeur intégrer et manipuler les tables. Remarque : ne devrait pas être utilisé pour contrôler la mise en page, mais uniquement pour les données organisées sous forme de tableaux.';
