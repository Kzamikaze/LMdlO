...
$lang['validation_regex_match'] = 'Valider l\'expression régulière';
$lang['validation_regex_nomatch'] = 'Ne pas valider l\'expression régulière';
...
$lang['title_cataloger_attribute_fields'] = 'Catalogue des champs d\'attribut';
...
$lang['help_name_regex'] = 'Une expression régulière pour filtrer par nom les items de Cataloger';
$lang['help_field_height'] = 'La hauteur du champ multiple';
$lang['title_name_regex'] = 'Nom de l\'expression régulière pour Cataloger';
...
$lang['title_allow_overwrite'] = 'Autoriser l\'écrasement des fichiers déjà existants lors de l\'upload ?';
...
$lang['file_doesnt_exists'] = 'Le fichier %s n\'existe pas.';
...
$lang['title_file_destination'] = 'Répertoire d\'enregistrement des fichiers&nbsp;';
...
$lang['title_remove_file_from_server'] = 'Supprimer les fichiers uploadés depuis le serveur après exécution (dispositions email)&nbsp;';
...
$lang['title_file_root'] = 'Dossier dans lequel le fichier sera sauvegardé&nbsp;';
...
$lang['title_field_logic_long'] = 'Données Smarty, javascript, ou toute autre donnée que vous voulez envoyer avec ce champ.<br />S\'exécute via le compilateur smarty, utiliser les balises {literal}{/literal} avec < script >< /script >';
...
$lang['operators_help'] = 'Si vous utilisez une évaluation de chaîne de caractères, la seule opération possible est la concaténation (+), alors que si vous utilisez une évaluation numérique, vous avez les symboles de base (, +, -, *, /, ). Si vous utilisez l\'évaluation par le PHP, vous pouvez utiliser n\'importe quelle fonction vous voulez, mais vous avez besoin de citer des choses (la substitution se produit avant l\'évaluation), par exemple, substr (\'$fld_22\',0,2).\'$fld_23\'.';
...
<tr><td>this_page</td><td>numéro de la page courante pour un formulaire multi-pages</td></tr>
