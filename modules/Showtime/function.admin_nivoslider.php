...
-----------------------------------------------------------------------------------------------------------*/
	...
	$keyvalues=array('None'=>'none',
                         'Nivo Slider Bar Theme'=>'bar',
                         'Nivo Slider Dark Theme'=>'dark',
                         'Nivo Slider Default Theme'=>'default',
                         'Nivo Slider Light Theme'=>'light');
	...
	$this->smarty->assign('template_input',	$this->CreateTextArea(false,$id,$caption_css,'caption_css','','caption_css','','','20','','','','style="width:300px;"'));
