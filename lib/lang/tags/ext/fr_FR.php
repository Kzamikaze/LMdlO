...
<ul>
  <li>label - <em>(<strong>required</strong> string)</em> Un label pour l\'option (celui ci est présenté à l\'utilisateur)</li>
  <li>value - <em>(<strong>required</strong> mixed)</em>Soit une valeur de chaîne pour l\'option, ou un tableau de définitions des options. 
